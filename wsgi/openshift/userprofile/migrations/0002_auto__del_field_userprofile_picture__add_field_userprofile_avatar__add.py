...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'userprofile_userprofile', 'avatar',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UserProfile.about_me'
        db.add_column(u'userprofile_userprofile', 'about_me',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'userprofile_userprofile', 'avatar')

        # Deleting field 'UserProfile.about_me'
        db.delete_column(u'userprofile_userprofile', 'about_me')
    ...
    models = {
        ...
        u'userprofile.privatemessage': {
            'Meta': {'object_name': 'PrivateMessage'},
            'from_user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'_from_user'", 'to': u"orm['userprofile.UserProfile']"}),
            ...
            'to_user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'_to_user'", 'to': u"orm['userprofile.UserProfile']"})
        },
